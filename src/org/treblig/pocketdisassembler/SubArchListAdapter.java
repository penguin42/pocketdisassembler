...
// An adapter used to display the names in the subarch spinner based on a list of SubarchDef's
// it always returns the displayed name
public class SubArchListAdapter implements SpinnerAdapter {

	public SubArchListAdapter(Context c, SubarchDef[] _defs) {
	  defs = _defs;
	  mContext = c;
